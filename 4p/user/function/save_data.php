...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO household_data (last_name, first_name, middle_name, extension_name, sexM, household_id_number, 
    barangay, city_municipality, province, region, income, child_name, child_dob, attending_school, reason_for_not_attending, 
    school_name, sexC, child1_name, child1_address, child1_school_name, child1_school_address, child1_grade_level, 
    child2_name, child2_address, child2_school_name, child2_school_address, child2_grade_level, 
    child3_name, child3_address, child3_school_name, child3_school_address, child3_grade_level) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?)");
